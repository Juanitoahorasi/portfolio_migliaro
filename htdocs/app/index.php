...
<head>
  ...
  <!-- Custom CSS -->
  <link href="../css/estilo.css" rel="stylesheet" type="text/css"> <!-- Asegúrate de que la ruta sea correcta -->

  <!-- Particles.js -->
  <script src="https://cdn.jsdelivr.net/particles.js/2.0.0/particles.min.js"></script>
</head>
<body>
<script src="Build/juego.loader.js"></script>
<div id="unityContainer"></div>
      ...
      <div class="row mb-4">
          <div class="col-md-6">
            <video class="w-100" controls>
              <source src="ruta/al/video1.mp4" type="video/mp4"> <!-- Cambia esta línea -->
              Tu navegador no soporta el video.
            </video>
          </div>
          <div class="col-md-6">
            <video class="w-100" controls>
              <source src="ruta/al/video2.mp4" type="video/mp4"> <!-- Cambia esta línea -->
              Tu navegador no soporta el video.
            </video>
          </div>
      </div>
  ...
  <iframe frameborder="0" src="https://itch.io/embed-upload/11902890?color=333333" allowfullscreen="" width="640" height="380"><a href="https://juanito-ahorasi.itch.io/towertawer">Play TowerTawer on itch.io</a></iframe>
    <div style="margin-left: 20px;">
        <img src="/img/controles.webp" alt="Controles del juego" width="300">
    </div>
</div>
